...
$_SESSION['EventAddress'] = $_POST["EventAddress"];
$_SESSION['ThirdParty'] = $_POST["ThirdParty"];
$_SESSION['HostInfo'] = $_POST["HostInfo"];
$_SESSION['EventType'] = $_POST["EventType"];
$_SESSION['EventAmbiance'] = $_POST["EventAmbiance"];
$_SESSION['EventOverview'] = $_POST["EventOverview"];
/* etc ?? this work?*/
...
<form class="form-horizontal" action="vendor-referral-requirements.php" method="post">
...
$('#vendorType').typeahead({source: subjects})  
 ...
 <input class="pull-right img-rounded" type="submit" value="Choose Referral Requirements"/>
</form>
</div>
</div>
</body>
